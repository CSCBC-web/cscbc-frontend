...
export default async function NewComersPage(props: { params: Params }) {
  ...
  switch (locale) {
    case "en":
      path = `${process.env.R2_ENDPOINT}/markdown/newGuest_en.md`;
      break;
    case "zh":
      path = `${process.env.R2_ENDPOINT}/markdown/newGuest_zh.md`;
      break;
    case "zh-Hant":
      path = `${process.env.R2_ENDPOINT}/markdown/newGuest_zh-Hant.md`;
      break;
    default:
      path = `${process.env.R2_ENDPOINT}/markdown/newGuest_en.md`; // default 'en'
  }
